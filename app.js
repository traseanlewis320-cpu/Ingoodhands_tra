/* --- MODULAR APP LOGIC: LUXE SALON & SPA RECREATION --- */
...
class App {
    ...
    bindEvents() {
        ...
        if (adminPassInp) {
            adminPassInp.oninput = () => {
                const biz = this.storage.getItem('business');
                biz.password = adminPassInp.value;
                this.storage.setItem('business', biz);
            };
        }
    ...
    applyBranding() {
        ...
        document.getElementById('admin-password-edit').value = biz.password;
